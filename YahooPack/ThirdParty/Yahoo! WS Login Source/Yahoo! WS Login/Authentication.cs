	...
	public class Authentication
    {
        ...
        public int HttpTimeout
		{
			...
			set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value", Properties.Resources.ErrorTimeoutOutOfRange);
                }
                else
                {
                    _httpTimeout = value;
        ...
        public System.IO.Stream GetAuthenticatedServiceStream(System.Uri wsAddress)
        {
            ...
            {
                throw new AuthenticationException(Properties.Resources.ErrorCookieNotSet, AuthenticationErrorCode.Other);
            }
