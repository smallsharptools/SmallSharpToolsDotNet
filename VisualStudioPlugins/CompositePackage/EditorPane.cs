...
namespace SmallSharpToolscom.CompositePackage
{
    ...
    //     - An empty xcp file in the same directory as NewFileItems.vsdir. In
    //       our case we chose Composite1.xcp. Note this file name appears in Editor.vsdir
    ...
    //          - "Composite1" - This is the base file name. New files will initially
    //             be named as Composite11.xcp, Composite12.xcp... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Composite1.xcp|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Composite1.xcp - our empty xcp file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        #region Fields
        private CompositePackage myPackage;
        ...
        private CompositeEditor editorControl;
        ...
        public EditorPane(CompositePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the xcp document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(CompositePackage package)
        {
            myPackage = package;
            loading = false;
            ...
            this.editorControl = new CompositeEditor();
        ...
        private float _defaultTabStop = 4;
        ...
        int IPersistFileFormat.Load(string pszFilename, uint grfMode, int fReadOnly)
        {
            ...
            try
            {
                ...
                if (lineRead.Contains(xmlSignature))
                {
        ...
        int IVsTextImage.GetSpanLength(TextSpan[] pts, out int pcch)
        {
            ...
            // TODO fix
            pcch = 0; //Math.Abs(endIndex - startIndex);
            ...
            )
        {
            ...
            //// TODO fix
            //int lineLength = 0; //lineText.Length;
        ...
        {
            // TODO fix
            piLineCount = 0; //editorControl.RichTextBoxControl.Lines.Length;
            return VSConstants.E_NOTIMPL;
        }
