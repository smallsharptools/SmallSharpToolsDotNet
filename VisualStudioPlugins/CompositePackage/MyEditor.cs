...
namespace SmallSharpToolscom.CompositePackage
{
    public partial class MyEditor : UserControl
    {
        ...
        public MyEditor()
        {
            ...
            m_Recorder = new VsMacroRecorder(GuidList.guidCompositePackageEditorFactory);
        }
        ...
        public int GetColumnFromIndex(int index)
        {
            ...
            // TODO fix
            int currentLineIndex = 0; // richTextBoxCtrl.GetFirstCharIndexOfCurrentLine();
        ...
        public int GetIndexFromLineAndColumn(int line, int column)
        {
            ...
            // TODO fix
            int firstCharLineIndex = 0; //richTextBoxCtrl.GetFirstCharIndexFromLine(line);
