...
namespace SmallSharpTools.VSX.Composite.CustomTools
{
    public class CompositeClassGenerator
    {
        ...
        private BaseCustomTool _customTool;
        ...
        public CompositeClassGenerator(
            BaseCustomTool customTool, CodeDomProvider codeGenerator, string inputFileName)
        {
            _customTool = customTool;
            _codeGenerator = codeGenerator;
            _inputFileName = inputFileName;
            _assemblies = customTool.GetReferencedAssemblies(false);
            _projectDirectory = customTool.GetProjectDirectory();
        }
        ...
        private CodeDomProvider CodeWriter
        {
            get
            {
