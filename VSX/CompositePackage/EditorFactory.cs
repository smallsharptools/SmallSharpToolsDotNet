...
namespace SmallSharpTools.VSX.Composite.VSPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidCompositePackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private CompositePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(CompositePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidCompositePackageEditorFactory;
            pgrfCDW = 0;
            ...
            CompositeEditorPane NewEditor = new CompositeEditorPane(editorPackage);
