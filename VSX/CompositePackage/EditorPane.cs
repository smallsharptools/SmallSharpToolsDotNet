...
namespace SmallSharpTools.VSX.Composite.VSPackage
{
    ...
    //       our case we chose Composite.xcp. Note this file name appears in Editor.vsdir
    ...
    //          - "Composite" - This is the base file name. New files will initially
    //             be named as Composite1.xcp, Composite2.xcp... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Composite.xcp|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Composite.xcp - our empty xcp file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidCompositePackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidCompositePackageCmdSet, PkgCmdIDList.IDMX_RTF);
