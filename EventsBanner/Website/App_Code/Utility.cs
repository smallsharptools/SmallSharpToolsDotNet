    ...
    public class Utility
    {
        ...
        public static bool IsAdminUser()
        {
            ...
            return (!String.IsNullOrEmpty(username) &&
                    SiteConfiguration.AdminUserName.Equals(username));
        }
        ...
        public static bool IsUserValid(string username, string password)
        {
            return (
                ...
                SiteConfiguration.AdminUserName.Equals(username.ToLower()) &&
                SiteConfiguration.AdminUserPassword.Equals(password)
            );
        }
